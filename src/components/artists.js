...
class Artists extends React.Component {
    ...
    componentDidMount() {
        ...
        if (artist != null) {
            fetch("http://localhost/W-WEB-090-PAR-1-1-spotify-andry.ramanana/W-WEB-090-PAR-1-1-spotify-andry.ramanana/API/spotify.php?get=artist&artist=" + artist).then(res => res.json()).then((result) => {
                this.setState({
                    isLoaded: true,
                    data: result,
                    max: 1
                });
                fetch("http://localhost/W-WEB-090-PAR-1-1-spotify-andry.ramanana/W-WEB-090-PAR-1-1-spotify-andry.ramanana/API/spotify.php?get=albums&artist=" + artist).then(res => res.json()).then((result) => {
                    this.setState({
                        isLoaded: true,
                        albums: result
                    });
            ...
            fetch("http://localhost/W-WEB-090-PAR-1-1-spotify-andry.ramanana/W-WEB-090-PAR-1-1-spotify-andry.ramanana/API/spotify.php?get=artists").then(res => res.json()).then((result) => {
                this.setState({
                    isLoaded: true,
                    data: result,
                    max: result.length
                ...
                if (limit != null && offset != null) {
                    fetch("http://localhost/W-WEB-090-PAR-1-1-spotify-andry.ramanana/W-WEB-090-PAR-1-1-spotify-andry.ramanana/API/spotify.php?get=artists&limit=" + limit + "&offset=" + offset).then(res => res.json()).then((result) => {
                        this.setState({
                            isLoaded: true,
                            data: result
                        });
