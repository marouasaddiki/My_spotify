...
class Albums extends React.Component {
    ...
    componentDidMount() {
        ...
        if(albumId != null) {
            fetch("http://localhost/W-WEB-090-PAR-1-1-spotify-andry.ramanana/W-WEB-090-PAR-1-1-spotify-andry.ramanana/API/spotify.php?get=album&album=" + albumId).then(res => res.json()).then((result) => {
                this.setState({
                    isLoaded: true,
                    data: result,
                    max: 1
                });
                fetch("http://localhost/W-WEB-090-PAR-1-1-spotify-andry.ramanana/W-WEB-090-PAR-1-1-spotify-andry.ramanana/API/spotify.php?get=tracks&album=" + albumId).then(res => res.json()).then((result) => {
                    this.setState({
                        isLoaded: true,
                        tracks: result
                    });
            ...
            fetch("http://localhost/W-WEB-090-PAR-1-1-spotify-andry.ramanana/W-WEB-090-PAR-1-1-spotify-andry.ramanana/API/spotify.php?get=albums").then(res => res.json()).then((result) => {
                this.setState({
                    isLoaded: true,
                    data: result,
                    max: result.length
                ...
                if(limit != null && offset != null) {
                    fetch("http://localhost/W-WEB-090-PAR-1-1-spotify-andry.ramanana/W-WEB-090-PAR-1-1-spotify-andry.ramanana/API/spotify.php?get=albums&limit=" + limit + "&offset=" + offset).then(res => res.json()).then((result) => {
                        this.setState({
                            isLoaded: true,
                            data: result
                        });
